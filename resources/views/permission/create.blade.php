...
@section('content')
    ...
    <div class="panel-container show">
        <div class="panel-content">
            <form action="{{ url('admin/setting/permission') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-2">
                ...
                <div class="row">
                    <div class="col-md-3 mb-2">
                        <div class="form-group">
                            ...
                            <div class="mb-1">
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" class="custom-control-input check_all" name="permission[]" id="import" value="Import">
